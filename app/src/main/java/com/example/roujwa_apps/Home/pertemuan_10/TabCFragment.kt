...
import com.example.roujwa_apps.databinding.FragmentTabCBinding // Ganti dengan package binding kamu yang benar

class TabCFragment : Fragment() {

    // 1. Deklarasi properti View Binding
    ...
    // 2. Inisialisasi View Binding di onCreateView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Pastikan nama adapter dan parameter di project kamu sesuai
    ...
    // 3. Bersihkan binding agar tidak memory leak
